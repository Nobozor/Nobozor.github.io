...
function f(a) {
    ...
    window.addEventListener ? (addEventListener("DOMContentLoaded", a.a, !1), addEventListener("load", a.a, !1), addEventListener("scroll", a.a,
        !1), addEventListener("resize", a.a, !1)) : window.attachEvent && (attachEvent("onDOMContentLoaded", a.a), attachEvent("onload", a.a), attachEvent("onscroll", a.a), attachEvent("onresize", a.a));
    a.a()
}
...
window.onload = function() {
    for (var a = document.getElementsByClassName("typeWriter"), b = 1; b < a.length; b++) {
